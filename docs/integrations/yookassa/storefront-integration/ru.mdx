...
Откройте [`src/lib/constants.tsx`](https://github.com/gorgojs/medusa-integrations/blob/27f930a93653eb95edbea41d4da126e5e9e2ff02/examples/payment-yookassa/medusa-storefront/src/lib/constants.tsx#L37-L40) и добавьте следующий код:
...
Откройте [`src/lib/data/cookies.ts`](https://github.com/gorgojs/medusa-integrations/blob/27f930a93653eb95edbea41d4da126e5e9e2ff02/examples/payment-yookassa/medusa-storefront/src/lib/data/cookies.ts#L79) и обновите конфигурацию файлов cookie следующим образом:
...
Откройте [`src/modules/checkout/components/payment-button/index.tsx`](https://github.com/gorgojs/medusa-integrations/blob/27f930a93653eb95edbea41d4da126e5e9e2ff02/examples/payment-yookassa/medusa-storefront/src/modules/checkout/components/payment-button/index.tsx#L163-L205) и добавьте следующий код:
...
Создайте файл [`src/app/api/capture-payment/[cartId]/route.ts`](https://github.com/gorgojs/medusa-integrations/blob/27f930a93653eb95edbea41d4da126e5e9e2ff02/examples/payment-yookassa/medusa-storefront/src/app/api/capture-payment/%5BcartId%5D/route.ts)  со следующим содержимым:
...
Вы можете ознакомиться с изменениями, внесенными в стартовый шаблон [Medusa Next.js Starter Template](https://github.com/medusajs/nextjs-starter-medusa) в директории [`examples/payment-yookassa/medusa-storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-yookassa/medusa-storefront).

Полный код интеграции можно посмотреть в разделе [comparison page](https://github.com/gorgojs/medusa-integrations/compare/%40gorgo/medusa-payment-yookassa%400.0.1...main), откройте вкладку `Files changed` и изучите различия в каталоге `examples/medusa-storefront`. Или запустите `diff` в терминале:

...
- **Storefront Example:** A ready-to-use <a href="https://github.com/gorgojs/medusa-plugins/tree/main/examples/fulfillment-apiship/medusa-storefront" target="_blank">Next.js storefrontexample </a> you can use as a reference.

---
title: "Интеграция ApiShip для Medusa"
description: "Плагин Medusa для интеграции с агрегатором служб доставки ApiShip"
---

<div>
  <img alt="Логотип Medusa-ApiShip" src="https://raw.githubusercontent.com/gorgojs/medusa-plugins/refs/heads/main/assets/apiship-medusa-logo.svg" width="270"/>
</div>

# {frontmatter.title}

Этот плагин интегрирует ApiShip в Medusa, предоставляя вашему магазину доступ к 40+ перевозчикам при минимальной настройке. Готов к продакшену.
...
- **Пример витрины магазина:** Готовый <a href="https://github.com/gorgojs/medusa-plugins/tree/main/examples/fulfillment-apiship/medusa-storefront" target="_blank">пример витрины на Next.js</a> - можно использовать как референс.

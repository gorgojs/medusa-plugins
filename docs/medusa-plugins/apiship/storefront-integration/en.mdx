...
description: "Learn how to integrate the ApiShip plugin into a Next.js storefront for Medusa."
---
...
This data must be loaded dynamically from the backend, presented to the customer in a convenient form, and then persisted in the cart so it can be used later by the plugin when creating an order in ApiShip.
...
Open [`src/modules/checkout/components/shipping-address/index.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and mark the phone input as required:
...
```tsx title="src/modules/checkout/components/shipping-address/index.tsx"
<Input
  label="Phone"
...
Open [`src/lib/data/cart.ts`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/lib/data/cart.ts#L217-L242) and add the following:
...
Open [`src/lib/data/fulfillment.ts`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/lib/data/fulfillment.ts#L70-L134) and add the following helpers:
...
```ts title="src/lib/data/fulfillment.ts"
import type { ApishipHttpTypes } from "@gorgo/medusa-fulfillment-apiship/types"
...
Open [`src/modules/checkout/components/shipping/apiship/types/index.ts`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following types:
...
```ts title="src/modules/checkout/components/shipping/apiship/types/index.ts"
import type { ApishipHttpTypes } from "@gorgo/medusa-fulfillment-apiship/types"
...
Open [`src/modules/checkout/components/shipping/apiship/utils/index.ts`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following helpers:
...
```ts title="src/modules/checkout/components/shipping/apiship/utils/index.ts"
import {
  ApishipCalculation,
  ApishipTariff,
} from "../types"
...
Open [`src/modules/checkout/components/shipping/apiship/apiship-map.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:
...
```tsx title="src/modules/checkout/components/shipping/apiship/apiship-map.tsx"
"use client"
...
Open [`src/modules/checkout/components/shipping/apiship/apiship-chosen.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:
...
```tsx title="src/modules/checkout/components/shipping/apiship/apiship-chosen.tsx"
"use client"
...
Open [`src/modules/checkout/components/shipping/apiship/apiship-pickup-point-modal.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:
...
```tsx title="src/modules/checkout/components/shipping/apiship/apiship-pickup-point-modal.tsx"
"use client"
...
Open [`src/modules/checkout/components/shipping/apiship/apiship-courier-modal.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:
...
```tsx title="src/modules/checkout/components/shipping/apiship/apiship-courier-modal.tsx"
"use client"
...
Open [`src/modules/checkout/components/shipping/apiship/index.ts`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:
...
```ts title="src/modules/checkout/components/shipping/apiship/index.ts"
...
Open [`src/modules/checkout/components/shipping/index.ts`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:
...
```tsx title="src/modules/checkout/components/shipping/index.tsx"
// ... other imports
...
You can refer to the modifications made in the [Medusa Next.js Starter Template](https://github.com/medusajs/nextjs-starter-medusa), which are located in the [`examples/medusa-storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/fulfillment-apiship/medusa-storefront) directory.

The complete integration diff can be viewed in the [comparison page](https://github.com/gorgojs/medusa-integrations/compare/%40gorgo/medusa-fulfillment-apiship%400.0.1...main), and explore the differences under the `examples/fulfillment-apiship/medusa-storefront` directory. Or run diff in the terminal:

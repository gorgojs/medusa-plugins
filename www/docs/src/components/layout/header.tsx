...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 z-50">
      <header
        className={cn(
          'flex items-center justify-between h-14 duration-300',
          scrolled
      ...
      >
        <div className="pl-4 flex shrink-0 xl:w-[250px] justify-start" suppressHydrationWarning>
        ...
        <div
          className={cn(
            'w-full flex justify-end lg:justify-between h-full transition-all border-t border-x border-transparent',
            scrolled ? 'xl:bg-ui-bg-base xl:border-ui-border-base' : 'bg-transparent'
          )}
        >

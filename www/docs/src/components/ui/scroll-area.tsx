...
>(({ className, children, showShadows = false, shadowSize = '1rem', ...props }, ref) => {
        ...
        >
          <div
            className={cn(
              ...
              'bg-gradient-to-b from-ui-bg-component to-transparent opacity-0 transition-opacity',
          ...
          <div
            className={cn(
              ...
              'bg-gradient-to-t from-ui-bg-component to-transparent opacity-0 transition-opacity',
          ...
          <div
            className={cn(
              ...
              'bg-gradient-to-r from-ui-bg-component to-transparent opacity-0 transition-opacity',
          ...
          <div
            className={cn(
              ...
              'bg-gradient-to-l from-ui-bg-component to-transparent opacity-0 transition-opacity',

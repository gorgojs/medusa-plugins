...
With this in place, the storefront can show the previously saved selection directly in the delivery step, including pickup point and tariff details when applicable, and let the user either remove it or reopen the modal window to change it.

## 8. Pickup Point Modal Window
...
## 9. Courier Tariff Selection Modal Window

...
- **Пример витрины магазина**  
  Готовый <a href="https://github.com/gorgojs/medusa-plugins/tree/main/examples/fulfillment-apiship/medusa-storefront" target="_blank">пример витрины на Next.js</a> - можно использовать как референс.
- **Тестовый режим**  

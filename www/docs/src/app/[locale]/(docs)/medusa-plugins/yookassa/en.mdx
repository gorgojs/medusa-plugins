...
To learn how to install and configure the YooKassa payment provider, check out the [Getting Started](./getting-started) guide.

## Storefront Integration

For instructions on how to integrate YooKassa payment provider in a Next.js storefront, see the [Storefront Integration](./storefront-integration) guide.

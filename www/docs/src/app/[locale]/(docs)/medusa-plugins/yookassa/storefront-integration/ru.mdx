...
description: "Узнайте, как интегрировать платежный провайдер ЮKassa в витрину магазина (Storefront) на Next.js, построенную с использованием Medusa."
---

# {frontmatter.title}

Для интеграции платёжного провайдера ЮKassa с витриной магазина (Storefront) на Next.js начните с добавления необходимых UI-компонентов. Таким образом провайдер будет отображаться на странице оформления заказа наряду с другими доступными методами оплаты.

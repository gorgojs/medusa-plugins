...
Чтобы узнать, как установить и настроить платежный провайдер Robokassa, ознакомьтесь с руководством [Быстрый старт](./getting-started).

## Интеграция с Storefront

Для получения инструкций по интеграции платежного провайдера Robokassa в storefront Next.js смотрите руководство [Интеграция с Storefront](./storefront-integration).

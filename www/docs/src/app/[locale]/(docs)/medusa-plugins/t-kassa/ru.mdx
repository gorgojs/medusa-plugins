...
<div className="not-prose mb-4 flex items-start gap-3 pl-1">
  ...
  <div>
    ...
    <div>Бренд мужской одежды</div>
  </div>
</div>

<Note>Хотите добавить ваш проект в этот список? Сделайте [Pull Request](https://github.com/gorgojs/medusa-plugins#contribution) или напишите в [чат поддержки](https://t.me/gorgojs_bot) в Telegram.</Note>

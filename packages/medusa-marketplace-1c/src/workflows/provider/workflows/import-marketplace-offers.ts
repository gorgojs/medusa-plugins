...
import { parseCommercemlOffersStep } from "../steps/parse-commerceml-offers"

export type ImportMarketplaceOffersOneCWorkflowInput = {
  offers: string[]
}

export const importMarketplaceOffersWorkflow = createWorkflow(
  "mp-1c-import-offers-workflow",
  (input: ImportMarketplaceOffersOneCWorkflowInput) => {
    const offersData = parseCommercemlOffersStep(input.offers)

...
**basicPrice** | [**GetPriceWithDiscountDTO**](GetPriceWithDiscountDTO.md) |  | [optional] [default to undefined]
**purchasePrice** | [**GetPriceDTO**](GetPriceDTO.md) |  | [optional] [default to undefined]
**additionalExpenses** | [**GetPriceDTO**](GetPriceDTO.md) |  | [optional] [default to undefined]
**cardStatus** | [**OfferCardStatusType**](OfferCardStatusType.md) |  | [optional] [default to undefined]
**campaigns** | [**Array&lt;OfferCampaignStatusDTO&gt;**](OfferCampaignStatusDTO.md) | Список магазинов, в которых размещен товар.  | [optional] [default to undefined]
**sellingPrograms** | [**Array&lt;OfferSellingProgramDTO&gt;**](OfferSellingProgramDTO.md) | Информация о том, какие для товара доступны модели размещения.  | [optional] [default to undefined]
**mediaFiles** | [**OfferMediaFilesDTO**](OfferMediaFilesDTO.md) |  | [optional] [default to undefined]
**archived** | **boolean** | Товар помещен в архив.  | [optional] [default to undefined]
...
```typescript
import { GetOfferDTO } from './api';

const instance: GetOfferDTO = {
    offerId,
    name,
    marketCategoryId,
    category,

...
------------ | ------------- | ------------- | -------------
**id** | **number** | Идентификатор товара в заказе.  Позволяет идентифицировать товар в рамках заказа.  | [optional] [default to undefined]
...
**instances** | [**Array&lt;OrderItemInstanceDTO&gt;**](OrderItemInstanceDTO.md) | Переданные коды маркировки. | [optional] [default to undefined]

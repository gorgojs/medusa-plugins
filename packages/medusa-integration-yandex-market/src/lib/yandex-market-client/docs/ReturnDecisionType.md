...
* `FastRefundMoney` (value: `'FAST_REFUND_MONEY'`)

* `RefundMoney` (value: `'REFUND_MONEY'`)

* `RefundMoneyIncludingShipment` (value: `'REFUND_MONEY_INCLUDING_SHIPMENT'`)

* `Repair` (value: `'REPAIR'`)

* `Replace` (value: `'REPLACE'`)

* `SendToExamination` (value: `'SEND_TO_EXAMINATION'`)

* `DeclineRefund` (value: `'DECLINE_REFUND'`)

...
**phones** | **Set&lt;string&gt;** | Номера телефонов точки продаж. Передавайте номер в формате: &#x60;+&lt;код страны&gt;(&lt;код города&gt;)&lt;номер&gt;[#&lt;добавочный&gt;]&#x60;.  Примеры: - &#x60;+7 (999) 999-99-99&#x60; - &#x60;+7 (999) 999-99-99#1234&#x60;  | [default to undefined]
...
```typescript
import { ChangeOutletRequest } from './api';

const instance: ChangeOutletRequest = {
    name,
    type,
    coords,
    isMain,

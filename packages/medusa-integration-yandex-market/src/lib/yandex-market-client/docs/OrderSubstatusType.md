...
* `CustomsFailedMarket` (value: `'CUSTOMS_FAILED_MARKET'`)

* `CustomsFailedUserCommercialItems` (value: `'CUSTOMS_FAILED_USER_COMMERCIAL_ITEMS'`)

* `CustomsFailedUserDutyNotPaid` (value: `'CUSTOMS_FAILED_USER_DUTY_NOT_PAID'`)

* `CustomsFailedUserInvalidPersonalData` (value: `'CUSTOMS_FAILED_USER_INVALID_PERSONAL_DATA'`)

* `CustomsFailedUserAdditionalDataNotProvided` (value: `'CUSTOMS_FAILED_USER_ADDITIONAL_DATA_NOT_PROVIDED'`)

* `AwaitPaymentAfterDelivery` (value: `'AWAIT_PAYMENT_AFTER_DELIVERY'`)

* `AwaitUserSteamFastUrl` (value: `'AWAIT_USER_STEAM_FAST_URL'`)

...
export const IntegrationDetailCredentialsSection = ({
  ...
  const api_key = integration.credentials?.api_key as string
    ...
    <>
      ...
      <Container>
          ...
          value={
            integration.credentials.business_id ? (
              <Badge size="xsmall" color="grey">
                {integration.credentials.business_id as React.ReactNode}
              </Badge>
            ) : (
              "-"
            )
        ...
        <SectionRow
          title="Campaign ID"
          value={
            integration.credentials.campaign_id ? (
              <Badge size="xsmall" color="grey">
                {integration.credentials.campaign_id as React.ReactNode}
              </Badge>
            ) : (
              "-" 
            )

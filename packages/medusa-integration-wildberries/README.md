...
<p align="center">
  ...
  <br/>
  <a href="https://github.com/gorgojs/medusa-plugins/blob/HEAD/packages/medusa-integration-wildberries/README.ru.md">Читать README на русском ↗</a>
</p>
...
Install both the Integration core plugin and the Wildberries provider:
...
module.exports = defineConfig({
  ...
  plugins: [
    ...
    // Register the integration core plugin and declare Wildberries as a provider
    {
...
| `providers[].resolve` | `string` | Yes      | Path to the provider module. For Wildberries: `@gorgo/medusa-integration-wildberries/providers/integration-wildberries` |
...
**`@gorgo/medusa-integration-wildberries` plugin options:**
...
Go to **Settings → Integration** to see a table of all configured integration integrations.
...
| **Provider**      | The integration type (e.g. `wildberries`)           |
...
3. Fill in the form:
   - **Title** — a human-readable name for this integration connection (e.g. "Wildberries Main Store").
...
The **Credentials** section is provided by the `@gorgo/medusa-integration-wildberries` widget on the integration detail page.

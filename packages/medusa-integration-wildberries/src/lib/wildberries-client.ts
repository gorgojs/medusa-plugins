...
const BASE_URLS = {
  ...
  integration: "https://marketplace-api-sandbox.wildberries.ru"
}
...
export function getWbApi(apiName: WildberriesApi, credentials: IntegrationWildberriesCredentialsType) {
  const APIS = {
    ProductCards: { 
      api: ProductCardsApi,

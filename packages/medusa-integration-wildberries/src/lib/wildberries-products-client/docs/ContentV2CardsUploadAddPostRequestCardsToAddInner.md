...
**vendorCode** | **string** | Supplier\&#39;s article | [default to undefined]
...
**description** | **string** | Product description.&lt;br&gt; The maximum number of characters depends on the product category&lt;br&gt; Standard - 2000, minimum - 1000, maximum - 5000&lt;br&gt; More details about description rules in **Product card filling rules** in [Instructions](https://seller.wildberries.ru/help-center/article/A-113) category of sellers portal  | [optional] [default to undefined]
**dimensions** | [**ContentV2CardsUploadAddPostRequestCardsToAddInnerDimensions**](ContentV2CardsUploadAddPostRequestCardsToAddInnerDimensions.md) |  | [optional] [default to undefined]
**sizes** | [**Array&lt;ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner&gt;**](ContentV2CardsUploadAddPostRequestCardsToAddInnerSizesInner.md) | Product sizes.&lt;br&gt; If the product has sizes but you send empty parameter, it is generated automatically with values: &#x60;techSize&#x60; &#x3D; \&quot;A\&quot;, &#x60;wbSize&#x60; &#x3D; \&quot;1\&quot; and some random SKU  | [optional] [default to undefined]
...
```typescript
import { ContentV2CardsUploadAddPostRequestCardsToAddInner } from './api';

const instance: ContentV2CardsUploadAddPostRequestCardsToAddInner = {
    brand,
    vendorCode,
    wholesale,
    title,

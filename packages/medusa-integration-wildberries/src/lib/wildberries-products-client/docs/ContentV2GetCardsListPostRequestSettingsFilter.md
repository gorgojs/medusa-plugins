...
**textSearch** | **string** | Seller\&#39;s article, Wildberries article or SKU search | [optional] [default to undefined]
...
**imtID** | **number** | Merged product cards ID search | [optional] [default to undefined]

...
**imtID** | **number** | Merged product cards ID.&lt;br&gt; The same for all WB article of group of merged product cards.&lt;br&gt; Every product card has &#x60;imtID&#x60;, even if is not merged with any other card  | [optional] [default to undefined]

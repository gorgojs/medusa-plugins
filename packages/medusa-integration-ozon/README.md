...
<p align="center">
  ...
  <br/>
  <a href="https://github.com/gorgojs/medusa-plugins/blob/HEAD/packages/medusa-integration-ozon/README.ru.md">Читать README на русском ↗</a>
</p>
...
Install both the Integration core plugin and the Ozon provider:

```bash
npm install @gorgo/medusa-integration @gorgo/medusa-integration-ozon
# or
yarn add @gorgo/medusa-integration @gorgo/medusa-integration-ozon
```
...
module.exports = defineConfig({
  ...
  plugins: [
    ...
    // Register the integration core plugin and declare Ozon as a provider
    {
...
| `providers[].resolve` | `string` | Yes      | Path to the provider module. For Ozon: `"@gorgo/medusa-integration-ozon/providers/integration-ozon"` |
...
**`@gorgo/medusa-integration-ozon` plugin options:**
...
| **Provider**      | The integration type (e.g. `ozon`)           |
...
2. Click **Add** to create a integration connection.
3. Fill in the form:
   - **Title** — a human-readable name for this integration connection (e.g. "Ozon Main Store").
...
The **Credentials** section is provided by the `@gorgo/medusa-integration-ozon` widget on the integration detail page.
...
1. Go to **Settings → Integrations** and select your Ozon integration.
...
> When the integration is enabled, only products that belong to mapped Medusa categories are exported to Ozon, and their payloads are built using the configured category and attribute mappings.

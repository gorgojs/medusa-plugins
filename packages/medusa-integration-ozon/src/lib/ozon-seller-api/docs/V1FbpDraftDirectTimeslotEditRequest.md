...
**timeslot_start** | **string** | Начало таймслота. | [optional] [default to undefined]

## Example

```typescript
import { V1FbpDraftDirectTimeslotEditRequest } from './api';

const instance: V1FbpDraftDirectTimeslotEditRequest = {
    row_version,
    supply_id,
    timeslot_start,
};

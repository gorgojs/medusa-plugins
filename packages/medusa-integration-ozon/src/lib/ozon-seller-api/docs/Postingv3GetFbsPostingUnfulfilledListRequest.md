...
**filter** | [**Postingv3GetFbsPostingUnfulfilledListRequestFilter**](Postingv3GetFbsPostingUnfulfilledListRequestFilter.md) |  | [default to undefined]
...
```typescript
import { Postingv3GetFbsPostingUnfulfilledListRequest } from './api';

const instance: Postingv3GetFbsPostingUnfulfilledListRequest = {
    dir,
    filter,
    limit,
    offset,

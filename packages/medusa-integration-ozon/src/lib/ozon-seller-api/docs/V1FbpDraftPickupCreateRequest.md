...
**delivery_details** | [**V1FbpDraftPickupCreateRequestDeliveryDetails**](V1FbpDraftPickupCreateRequestDeliveryDetails.md) |  | [optional] [default to undefined]
...
```typescript
import { V1FbpDraftPickupCreateRequest } from './api';

const instance: V1FbpDraftPickupCreateRequest = {
    bundle_id,
    delivery_details,
    package_units_count,
    warehouse_id,

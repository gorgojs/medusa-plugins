...
**financial_data** | [**V2PostingFinancialDataFBOV2**](V2PostingFinancialDataFBOV2.md) |  | [optional] [default to undefined]
...
```typescript
import { V2FboPostingV2 } from './api';

const instance: V2FboPostingV2 = {
    additional_data,
    analytics_data,
    cancel_reason_id,
    created_at,

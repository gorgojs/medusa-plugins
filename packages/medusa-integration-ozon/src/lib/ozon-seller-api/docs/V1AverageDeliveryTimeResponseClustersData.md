...
------------ | ------------- | ------------- | -------------
**another_delivery_time** | [**Array&lt;V1AverageDeliveryTimeResponseClustersDataAmnesty&gt;**](V1AverageDeliveryTimeResponseClustersDataAmnesty.md) | Зачли с другим временем доставки. | [optional] [default to undefined]
...
**delivery_time_status** | [**V1AverageDeliveryTimeResponseDeliveryTimeStatus**](V1AverageDeliveryTimeResponseDeliveryTimeStatus.md) |  | [optional] [default to undefined]
...
```typescript
import { V1AverageDeliveryTimeResponseClustersData } from './api';

const instance: V1AverageDeliveryTimeResponseClustersData = {

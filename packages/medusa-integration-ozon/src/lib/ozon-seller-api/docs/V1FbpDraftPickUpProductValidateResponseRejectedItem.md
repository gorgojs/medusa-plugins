...
**offer_id** | **string** | Артикул товара в системе продавца. | [optional] [default to undefined]
...
```typescript
import { V1FbpDraftPickUpProductValidateResponseRejectedItem } from './api';

const instance: V1FbpDraftPickUpProductValidateResponseRejectedItem = {
    barcode,
    icon_name,
    name,
    offer_id,

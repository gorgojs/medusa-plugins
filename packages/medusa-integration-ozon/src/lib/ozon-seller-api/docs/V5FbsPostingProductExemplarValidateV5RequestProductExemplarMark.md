...
```typescript
import { V5FbsPostingProductExemplarValidateV5RequestProductExemplarMark } from './api';

const instance: V5FbsPostingProductExemplarValidateV5RequestProductExemplarMark = {
    mark,
    mark_type,
};
```

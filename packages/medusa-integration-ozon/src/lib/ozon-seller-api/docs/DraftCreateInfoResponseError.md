...
```typescript
import { DraftCreateInfoResponseError } from './api';

const instance: DraftCreateInfoResponseError = {
    error_message,
    error_reasons,
    items_validation,

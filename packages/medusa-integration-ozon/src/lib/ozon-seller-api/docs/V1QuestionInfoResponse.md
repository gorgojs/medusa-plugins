...
**author_name** | **string** | Автор вопроса. | [optional] [default to undefined]
...
**status** | **string** | Статус вопроса:   - &#x60;NEW&#x60; — новый,   - &#x60;ALL&#x60; — все вопросы,   - &#x60;VIEWED&#x60; — просмотренный,   - &#x60;PROCESSED&#x60; — обработанный,   - &#x60;UNPROCESSED&#x60; — необработанный.  | [optional] [default to undefined]
**text** | **string** | Текст вопроса. | [optional] [default to undefined]

## Example

```typescript
import { V1QuestionInfoResponse } from './api';

const instance: V1QuestionInfoResponse = {
    answers_count,
    author_name,
    id,
    product_url,

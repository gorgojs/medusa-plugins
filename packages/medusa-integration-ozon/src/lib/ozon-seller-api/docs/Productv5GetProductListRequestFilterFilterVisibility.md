...
* `EmptyStock` (value: `'EMPTY_STOCK'`)

* `NotModerated` (value: `'NOT_MODERATED'`)

* `Moderated` (value: `'MODERATED'`)

* `Disabled` (value: `'DISABLED'`)

* `StateFailed` (value: `'STATE_FAILED'`)

* `ReadyToSupply` (value: `'READY_TO_SUPPLY'`)

* `ValidationStatePending` (value: `'VALIDATION_STATE_PENDING'`)

* `ValidationStateFail` (value: `'VALIDATION_STATE_FAIL'`)

* `ValidationStateSuccess` (value: `'VALIDATION_STATE_SUCCESS'`)

* `ToSupply` (value: `'TO_SUPPLY'`)

* `InSale` (value: `'IN_SALE'`)

* `RemovedFromSale` (value: `'REMOVED_FROM_SALE'`)

* `Overpriced` (value: `'OVERPRICED'`)

* `CriticallyOverpriced` (value: `'CRITICALLY_OVERPRICED'`)

* `EmptyBarcode` (value: `'EMPTY_BARCODE'`)

* `BarcodeExists` (value: `'BARCODE_EXISTS'`)

* `Quarantine` (value: `'QUARANTINE'`)

* `Archived` (value: `'ARCHIVED'`)

* `OverpricedWithStock` (value: `'OVERPRICED_WITH_STOCK'`)

* `PartialApproved` (value: `'PARTIAL_APPROVED'`)

...
```typescript
import { V1FbpDraftDropOffRegistrateResponseRegistrationErrorBundleError } from './api';

const instance: V1FbpDraftDropOffRegistrateResponseRegistrationErrorBundleError = {
    errors,
    sku,
};
```
